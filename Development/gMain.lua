...
outros = {
	...
	spooferLocal = true, -- Sistema local de spoofing (Se estiver desativado o sistema irá fazer a pesquisa via API Global) [true = Pesquisa apenas no seu servidor | false = Pesquisa via API Global]
	antivpn = {
