...
client
  .on("ready", () => {
    ...
    client.user.setActivity(
      "Mantenha seu servidor de mta livre de cheaters! Peça já sua key em .gg/awareness"
    );
  })
    ...
    if (interaction.isButton()) {
      if (interaction.customId === "formulario") {
        ...
        const pergunta3 = new Discord.TextInputBuilder()
          ...
          .setMaxLength(68) // Máximo de caracteres para a resposta
      ...
      if (interaction.customId === "modal") {
        ...
        if (
          ...
          return interaction.reply({
            content: `**${interaction.user.username}**, seu pedido foi cancelado devido ao introduzir dados inválidos (Duração)`,
          });
        ...
        let embed = new Discord.EmbedBuilder()
          ...
          .setDescription(
            `O usuário ${interaction.user} enviou o pedido abaixo:`
          )
          .addFields(
            {
            ...
            {
              name: `👤 Qual é o endereço de email:`,
        ...
        if (resposta3) {
          interaction
            .reply({
              content: `Olá **${interaction.user.username}**, foi enviado as credenciais para o seu e-mail!`,
              ephemeral: true,
            })
            .then((m) => {
              setTimeout(() => {
          ...
          interaction
            .reply({
              content: `Olá **${interaction.user.username}**, seu pedido está em espera.\n**Atenção** deixe a DM ligada!`,
              ephemeral: true,
            })
            .then((m) => {
              setTimeout(() => {
